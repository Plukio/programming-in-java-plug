...
public class ActivityFixtures {
    ...
    public static final Activity running = new Activity(1L, 0L, "SYSTEM", "Running", 10.0);
    public static final Activity jogging = new Activity(2L, 1L, "USER", "Jogging", 7.0);

    public static final Activity newUserActivity = new Activity(3L, 1L, "USER", "Swimming", 8.0);

    public static final NewActivity newActivity = new NewActivity(1L, "USER", "Swimming", 10.0);

    public static final Activity updatedActivity = new Activity(3L, 1L, "USER", "Swimming", 10.0);
